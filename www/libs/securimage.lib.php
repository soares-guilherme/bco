...
class Securimage {
   ...
   * @var string
   */
  var $charset = 'ABCDEFGHKLMNPRSTUVWZ3689abcdeghijklmnopstuvxz';
   ...
   * @var string
   */
  var $ttf_file = "./res/securimage.ttf";
   ...
   * @var string
   */
  var $multi_text_color = "#0a68dd,#f65c47,#8d32fd,#ff0000";
  ...
  function arcLines()
  {
    ...
    $xpos   = $this->text_x_start + ($this->font_size) + rand(-5, 5);
  ...
  function drawWord()
  {
    if ($this->use_gd_font == true) {
      ...
      $y_min = ($this->image_height / 2) + ($this->font_size / 3) - 2;
      $y_max = ($this->image_height / 2) + ($this->font_size / 3) + 2;
